...
<form action="./salva_novo.php" class="ls-form ls-form-horizontal" method="POST">
    ...
    <input type="text" name="segmento" placeholder="" value="" >
  </label>
    <label class="ls-label col-md-3">
    ...
    <input type="text" name="eixo" placeholder="" value="2" >
