...
$query = "SELECT * FROM tb_usuario WHERE id IN (SELECT user_id FROM tb_boleto WHERE situacao='PG' AND categoria>99) AND id=$id_cracha ORDER BY nome ASC"; 
