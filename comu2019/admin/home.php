...
<?
	...
	$count3 = mysql_query("SELECT COUNT(*) FROM `tb_trabalhos` WHERE area_id = $z");
...
<?
	...
	$count96 = mysql_query("SELECT COUNT(*) FROM `tb_boleto` WHERE categoria = $f AND situacao='PG'");

	$socios96 =  mysql_result($count96, 0);
	...
	echo "<tr>
			...
			<td>".$row115['grupo']."   ".utf8_encode($row115['nome'])."</td>
